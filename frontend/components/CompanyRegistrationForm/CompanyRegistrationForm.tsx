    ...
    return (
        <div className="flex bg-white rounded-2xl shadow-lg overflow-hidden max-w-4xl mx-auto">
            <div className="w-1/2 p-8 flex flex-col justify-center items-center">
                {!isConnected && (
                    <h2 className="text-xl font-semibold mb-6 text-center">Connect to your Car Tracker account</h2>
                )}
                <ConnectButton />
                {isConnected && !isChecking && (
                    <div className="w-full flex flex-col">
                        ...
                        <p className="text-gray-500 mb-8">It seems you are new here. Please register your company to continue!</p>
            ...
            <div className="w-1/2">
                <Image src={lava} alt="Image" className="w-full h-full object-cover" />
            </div>
        </div>
    );
};
