...
export default function VehicleInfoBox({
    ...
    return (
        <div className="shadow-lg mt-6 rounded-lg flex flex-col justify-between p-4 h-48 w-48 mx-2 bg-white">
            <div
                className={`rounded-full p-3 ${backgroudColor} flex items-center justify-center w-12 h-12`}
            >
                {icon}
            </div>
